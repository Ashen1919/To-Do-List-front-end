export default function HomeContent() {
    return(
        <div className="w-full h-[90vh] flex bg-gray-700">
            <div className="w-[50%] h-full p-5 relative">
                ...
                <button className="absolute bottom-[10rem] bg-blue-700 text-white font-semibold p-5 rounded-lg cursor-pointer border-2 border-blue-700 hover:bg-blue-800 transition duration-500 text-xl">Get Started</button>
            </div>
